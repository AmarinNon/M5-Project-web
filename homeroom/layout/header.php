...
<nav class="navbar navbar-inverse navbar-fixed-top pmd-navbar">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav top-nav has-separator copy-to-side hidden-xs">
      <?php
        ...
        for($i = 0 ; $i < count($homeroom_list) ; $i++) {
          ...
          <li role="presentation">
            <a href="swap_module.php?homeroom_id='.$homeroom_list[$i]->id.'&url='.urlencode(CURRENT_URL).'" tabindex="-1" role="menuitem">Homeroom '.$homeroom_list[$i]->name.'</a>
          </li>
          ';
        }
      ...
      <li class="">
        <a href="#" class="toggle-modal" data-target="#add-homeroom-modal" data-toggle="tooltip" data-placement="auto" title="Add Homeroom">
          <img src="images/svg/plus-13.svg" class="">
          <span class="visible-xs-inline-block ml-3">Add Homeroom</span>
        </a>
      </li>
    ...
    <ul class="nav navbar-nav top-nav has-separator copy-to-side hidden-xs">
      ...
      <li class="">
        <a href="#" class="toggle-modal" data-target="#add-subject-modal" data-toggle="tooltip" data-placement="auto" title="Add subjects">
          <img src="images/svg/plus-13.svg" class="">
          <span class="visible-xs-inline-block ml-3">Add subjects</span>
        </a>
      </li>
    </ul>
    <?php } ?>
    ...
    <ul class="nav navbar-nav top-nav navbar-right">
      ...
      ?>
      <li>
        <a href="message.php" title="message" class="pmd-ripple-effect notification " data-toggle="tooltip" data-placement="auto" title="message">
