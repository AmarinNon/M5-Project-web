      ...
      <div class="row">
        ...
        if(count($message)) {
          for($i = 0; $i < count($message); $i++){
            ...
            if($sent_user->role == 'Teacher'){ 
              ...
              $sent_form = 'จาก '.$sent_user->name.' '.$sent_user->surname.' ครูประจำชั้น '.$sent_homeroom->name;
            }
        ...
        <?php }
          ...
          <div class="pmd-card pmd-z-depth fill-gray">
            <div class="pmd-card-title">
              <div class="media-body media-middle">
                <h2 class="pmd-card-title-text">ถึง นักเรียน</h2>
              </div>
            </div>
            <div class="pmd-card-body">
              <form id="message_student_form" action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <button name="submit_message_student" class="btn btn-default-fill">ส่งข้อความ</button>
                </div>
              </form>
            </div>
          </div>
