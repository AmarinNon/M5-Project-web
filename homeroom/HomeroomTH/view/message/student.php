    ...
    <div class="row">
      <div class="col-xs-12">
        <h1 class="section-title">
          ...
          <span class="media-middle">ข้อความ</span>
        </h1>
      </div>
      <div class="col-sm-3">
      ...
      <?php if($filter == 'inbox') {
        ...
        for($i = 0; $i < count($message); $i++){
          ...
          if($message[$i]->message_type == '4'){ 
            $sent_role = 'ครูประจำชั้น';
            $sent_form = 'จาก '.$sent_role.' '.$sent_user->name.' '.$sent_user->surname;
          }
            ...
            $sent_form = 'จาก วิชา '.$sent_subject->name.' ชั้น '.$subject_homeroom->name.' / '.$sent_user->name.' '.$sent_user->surname;
          }
        ?>
      ...
      <?php }
        ...
        <div class="pmd-card pmd-z-depth fill-gray">
          <div class="pmd-card-title">
            <div class="media-body media-middle">
              <h2 class="pmd-card-title-text">ถึง ครูประจำชั้น</h2>
            </div>
          </div>
          <div class="pmd-card-body">
            <form id="message_homeroom_form" action="" method="POST">
              ...
              <div class="form-group">
                ...
                <button name="submit_message_homeroom" class="btn btn-default-fill">ส่งข้อความ</button>
              </div>
            </form>
          </div>
        </div>
