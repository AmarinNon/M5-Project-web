...
if(count($prakard) > 0) {
  ...
  $date_updated = 'แก้ไขประกาศล่าสุดเมื่อ : '.System::convertDateTH($prakard[0]->updatedatetime, true);
} else {
  $message = '';
  $date_updated = '';
}
      ...
      <div class="row">
        <div class="col-xs-12">
          <h1 class="section-title">
            ...
            <span class="media-middle">Homeroom ชั้น
          ...
          <div class="pmd-card pmd-z-depth fill-gray">
            <div class="pmd-card-title">
              <div class="media-body media-middle">
                <h2 class="pmd-card-title-text">ประกาศ</h2>
              </div>
            </div>
            <div class="pmd-card-body">
              <form action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-default-fill">ส่งข้อความ</button>
                </div>
              </form>
            </div>
          </div>
