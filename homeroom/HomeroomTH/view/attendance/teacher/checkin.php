...
<form action="" method="post" class="form-inline">
  <div class="form-group">
    <label class="text-blue mt-1 mr-2 control-label">ประจำวันที่</label>
    ...
    <table class="table pmd-table table-striped table-bordered pmd-data-table" data-paging="false" data-searching="false" data-info="false">
      ...
      <tbody>
        <?php for($i = 0 ; $i < count($student) ; $i++) { ?>
          ...
          <td>
            <?php
            echo '<input type="hidden" name="homeroom_id['.$i.']" value="'.$subject->homeroom_id.'">';
  ...
  <div class="form-group pull-right">
    ...
    <button type="submit" class="btn pmd-ripple-effect btn-default-fill">บันทึกข้อมูล</button>
  </div>
</form>