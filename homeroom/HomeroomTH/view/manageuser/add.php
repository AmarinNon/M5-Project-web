<?php
  ...
  if(isset($_POST['submit_register'])) {
    ...
    if($register_result->response_status) {
      ...
      System::notification('เพิ่มครูสำเร็จ', 'success');
            ...
            <div class="row">
              ...
              <form action="" method="POST" class="form-horizontal has-validator" role="form" data-toggle="validator">
                ...
                <div class="form-group col-xs-12">
                    <label for="" class="control-label">บัญชีผู้ใช้</label>
                ...
                <div class="form-group col-xs-12 text-right mt-3">
                  <button name="submit_register" type="submit" class="btn btn-default-fill">เพิ่มครู</button>
                </div>
