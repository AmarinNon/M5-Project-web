...
<div id="content" class="pmd-content inner-page">
  <div class="container-fluid full-width-container">
    <h1 class="section-title">
      ...
      <span class="media-middle">จัดการรายชื่อครู</span>
    </h1>
        ...
        <div class="col-xs-12">
          <div>
            <span class="btn-with-icon">
              ...
              <span class="fa fa-plus btn-icon img-circle"></span>เพิ่มครู</a>
            </span>
            <span class="btn-with-icon">
              ...
              <table class="table pmd-table pmd-data-table table-striped table-bordered">
                ...
                <?php
                  ...
                  <tr class="fadeIn animated">
                    ...
                    <td class="thin-cell">
                      <a href="manageuser.php?action=edit&id=<?php echo $user[$i]->user_id; ?>" class="smaller-80 mr-2" data-toggle="tooltip" title="แก้ไข"><span class="fa fa-pencil"></span></a>
                      <?php if($user[$i]->status == 'Active') { ?>
                        <form action="" method="POST" class="inline">
                          <input type="hidden" value="<?php echo $user[$i]->user_id; ?>" name="user_id">
                          <input type="hidden" value="ban" name="action">
                          <button type="submit" class="smaller-80 btn-link" data-toggle="tooltip" title="แบน"><span class="fa fa-lock"></span></button>
                        </form>
                      <?php } else { ?>
                        <form action="" method="POST" class="inline">
                          <input type="hidden" value="<?php echo $user[$i]->user_id; ?>" name="user_id">
                          <input type="hidden" value="unban" name="action">
                          <button type="submit" class="smaller-80 btn-link" data-toggle="tooltip" title="ปลดแบน"><span class="fa fa-unlock"></span></button>
                        </form>
                      <?php } ?>
                    </td>
                  </tr>
