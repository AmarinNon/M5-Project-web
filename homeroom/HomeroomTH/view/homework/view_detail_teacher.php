  ...
  <div class="pmd-card-body">
    ...
    <div class="clearfix">
      <div class="pull-left mt-4">
        <a href="homework.php?action=edit&id=<?php echo $homework->id; ?>" class="btn btn-default"><span class="smaller-80 fa fa-pencil mr-2"></span>แก้ไขงาน</a>
        <?php
      ...
      <div class="pull-right mt-4">
        <form action="" method="POST">
          ...
          <a href="#" class="btn btn-default-fill bg-red toggle-confirm" data-toggle="tooltip" title="ลบ" data-message="ยืนยันการลบข้อมูล"><span class="smaller-80 fa fa-trash-o mr-2"></span>ลบงาน</a>
        </form>
      </div>
    </div>
  </div>
