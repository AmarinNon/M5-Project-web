...
<div id="content" class="pmd-content inner-page">
  <div class="container-fluid full-width-container">
    <div class="row">
      ...
      <div class="col-xs-12">
        <a href="homework.php?filter=all" class="btn btn-default pmd-ripple-effect <?php echo ($filter == 'all')? 'active':'' ;?>">ทั้งหมด</a>
        <!-- <div class="btn-group"> -->
          <a href="homework.php?filter=today" class="btn pmd-ripple-effect btn-default <?php echo ($filter == 'today')? 'active':'' ;?>">ส่งวันนี้</a>
          <a href="homework.php?filter=tomorrow" class="btn pmd-ripple-effect btn-default <?php echo ($filter == 'tomorrow')? 'active':'' ;?>">ส่งพรุ่งนี้</a>
          <a href="homework.php?filter=late" class="btn pmd-ripple-effect btn-default <?php echo ($filter == 'late')? 'active':'' ;?>">เลยกำหนด</a>
        <!-- </div> -->
