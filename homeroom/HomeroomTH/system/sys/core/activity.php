...
<div class="container">
	<?php include 'def/defHeader.php'; showMainBar('activity'); ?>
		...
		<div class="span12">
			<div class="pagination pagination-centered">
				<ul>
					...
					echo '<li class="'.$class.'"><a href="activity.php?select=all">ALL</a></li>'; 
					if($_GET['select']=='server') $class='active'; else $class='';
					echo '<li class="'.$class.'"><a href="activity.php?select=server">SERVER</a></li>';
					if($_GET['select']=='api') $class='active'; else $class='';
					echo '<li class="'.$class.'"><a href="activity.php?select=api">API</a></li>';
					?>
				</ul>
			</div>
		</div>
		...
		<div class="span12">
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					{
						while($array = mysql_fetch_array($actionloglist))
						{
							echo "<tr>";
							echo "<td>". $array["id"] ."</td>";
