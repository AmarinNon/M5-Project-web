...
if(isset($_POST['submit_homework'])){
  ...
  if(count($homework_result) > 0) {
    ...
    System::notification('Add homework success' ,'success');
    System::redirect();
  } else {
    System::notification('Add homework unsuccess' ,'danger');
    System::redirect();
  }
}
...
if(isset($_POST['action'])){
  if($_POST['action'] == 'delete') {
    ...
    System::notification('Delete homework success', 'success');
        ...
        <div class="mt-3">
          <ul class="nav nav-pills nav-stacked nav-outline">
            ...
            <li class="<?php echo ($filter == $homework[$i]->id)? 'active':'' ;?>">
                <a href="homework.php?action=view&id=<?php echo $homework[$i]->id; ?>" class="pmd-ripple-effect">Work No. <?php echo $homework[$i]->shortname; ?></a>
            </li>
            <?php } ?>
          </ul>
        </div>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <form action="" method="POST" id="homework_form" enctype="multipart/form-data">
            ...
            <div class="form-group col-sm-5">
              ...
              <select name="" class="form-control" id="previous_homework">
                ...
                for($i = 0 ; $i < count($homework_list) ; $i++) {
                  ...
                  echo 'Work No. '.$homework_list[$i]->shortname.'] - ';
                  echo $subject->name;
                  echo ' '.$homeroom->name;
                  echo '</option>';
                }
              ...
              <p class="help-block mt-1 no-margin-bottom">*If your want to post it again</p>
            </div>
            ...
            <div class="form-group col-sm-4">
              <label for="" class="control-label">Submit Date</label>
            ...
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <div class="smaller-80">* Attach (*.pdf , *.doc, *.docx)</div>
            </div>
            <div class="form-group col-sm-6 col-xs-12">
