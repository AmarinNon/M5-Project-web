...
<div id="content" class="pmd-content inner-page">
  <div class="container-fluid full-width-container">
    <h1 class="section-title">
      ...
      <span class="media-middle">Homeroom Management</span>
    </h1>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="btn-with-icon">
            ...
            <span class="fa fa-plus btn-icon img-circle"></span>Add Homeroom</a>
          </div>
              ...
              <table class="table pmd-table table-striped table-bordered">
                ...
                ?>
                  <tr class="fadeIn animated">
                    <td><?php echo $i + 1; ?></td>
                    <td class="text-left">
                      Homeroom Class <?php echo $homeroom_list[$i]->name; ?>
                    </td>
                    <td class="thin-cell">
                      <a href="teacher_manage.php?action=edit&id=<?php echo $homeroom_list[$i]->id;?>" class="smaller-80 mr-2" data-toggle="tooltip" title="Edit"><span class="fa fa-pencil"></span></a>
                      ...
                      <form action="" method="POST" class="inline">
                        ...
                        <a href="#" class="smaller-80 btn-link toggle-confirm" data-toggle="tooltip" title="Delete" data-message="Confirm delete"><i class="fa fa-trash-o text-danger"></i></a>
                      </form>
                      <?php } else { ?>
                        <i class="fa fa-trash-o smaller-80" data-toggle="tooltip" title="Can't delete Homeroom"></i>
                      <?php } ?>
                    </td>
                  </tr>
                  <?php
        ...
        ?>
        <div class="col-md-6">
          <h1 class="text-blue bigger-130 text-center">Edit Homeroom</h1>
          <div class="mt-3 pmd-card">
            <form action="" method="POST">
              <div class="form-group">
                <label for="" class="control-label text-info bigger-110">Name Homeroom</label>
                <input name="name" type="text" id="" class="form-control" placeholder="Ex. M.6/1" required value="<?php echo $homeroom->name; ?>" autofocus>
              </div>
