    ...
    <div class="row">
      ...
      <div class="col-sm-3">
          <div class="btn-with-icon">
            ...
            <span class="fa fa-plus btn-icon img-circle"></span>Add work</a>
          </div>
          ...
          <div class="tab-subject mt-3">
            ...
            <ul class="nav nav-pills nav-stacked nav-outline">
              <li role="presentation" class="active">
                  <a href="#homework-1" aria-controls="home" class="pmd-ripple-effect">Work No.1</a>
              </li>
              <li role="presentation">
                  <a href="#homework-2" aria-controls="tab"  class="pmd-ripple-effect">Work No.2</a>
              </li>
            </ul>
          </div>
      </div>
            ...
            <div class="pmd-card pmd-z-depth fill-gray">
              <div class="pmd-card-title clearfix">
                ...
                <div class="media-right pull-right">
                  <h2 class="pmd-card-title-text">ส่ง 13/09/2017</h2>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <form action="">
              <div class="form-group col-sm-2">
                <label for="" class="control-label text-info bigger-110">"Work number</label>
                <input type="text" id="" class="form-control">
              </div>
              <div class="form-group col-sm-5">
                <label for="" class="control-label text-info bigger-110">Work name</label>
                <input type="text" id="" class="form-control">
              </div>
              <div class="form-group col-sm-5">
                <label for="" class="control-label text-info bigger-110">Homework that ever post before</label>
                <select name="" id="" class="form-control" required="required">
                  <option disabled selected>Don't choose</option>
                </select>
                <p class="help-block mt-1 no-margin-bottom">*If your want to select work that post before</p>
              </div>
              ...
              <div class="form-group col-sm-2">
                ...
                <select name="" id="" class="form-control" required="required">
                  <option value="">Single work</option>
              ...
              <div class="form-group col-sm-4">
                <label for="" class="control-label">Submit</label>
                <input type="date" id="" class="form-control">
              </div>
              <div class="form-group col-sm-2">
                <label for="" class="control-label"></label>
                <button type="button" class="btn btn-default-fill">Save</button>
              </div>
            </form>
          </div>
        </div>
