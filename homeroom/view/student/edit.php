<?php
  ...
  if(isset($_POST['edit_student'])) {
    ...
    if($edit_student_result->response_status > 0) {
      System::notification('Edit student information success', 'success');
      System::redirect();
    } else {
      System::notification('Edit student information unsuccess', 'error');
    }
  }
  ...
  if(isset($_POST['edit_parent'])) {
    ...
    if($edit_parent_result->response_status > 0) {
      System::notification('Edit parent information success', 'success');
      System::redirect();
    } else {
      System::notification('Edit parent information unsuccess', 'error');
    }
  }
?>
        ...
        <div class="row">
          <form action="" method="POST" class="form-horizontal has-validator" role="form" data-toggle="validator">
            ...
            <div class="col-xs-12">
              <div class="row">
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <input type="text" name="number" id="number" class="form-control" required maxlength="2" pattern="[0-9]+" data-pattern-error="Number must be number only" value="<?php echo $user->group; ?>">
            ...
            <div class="form-group col-xs-12 text-right mt-3">
              <button name="edit_student" type="submit" class="btn btn-default-fill">Save data</button>
            </div>
          </form>
        </div>
      </div>
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <input type="text" name="parent_tel" id="parent_tel" class="form-control" required maxlength="10" pattern="[0-9]+" data-pattern-error="Phone number must be number only" value="<?php echo $parent->tel; ?>">
                    <div class="mt-1 help-block with-errors invalid-feedback"></div>
                </div>
                <div class="form-group col-xs-12 text-right mt-3">
