...
<div id="content" class="pmd-content inner-page">
  <div class="container-fluid full-width-container">
    <h1 class="section-title">
      ...
      <span class="media-middle">Manage subjects</span>
    </h1>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="btn-with-icon">
            ...
            <span class="fa fa-plus btn-icon img-circle"></span>Add subjects</a>
          </div>
              ...
              <table class="table pmd-table table-striped table-bordered">
                ...
                ?>
                  <tr class="fadeIn animated">
                    ...
                    <td class="thin-cell">
                      <a href="teacher_manage.php?action=edit&id=<?php echo $subject_list[$i]->id;?>" class="smaller-80 mr-2" data-toggle="tooltip" title="Edit"><span class="fa fa-pencil"></span></a>
                    <?php if(Homeroom::subject_removable($subject_list[$i]->id)) { ?>
                      <form action="" method="POST" class="inline">
                        ...
                        <a href="#" class="smaller-80 btn-link toggle-confirm" data-toggle="tooltip" title="Delete" data-message="Delete confirm"><span class="fa fa-trash-o text-danger"></span></a>
                      </form>
                    <?php } else { ?>
                      <span class="fa fa-trash-o smaller-80" data-toggle="tooltip" title="Cann't delete subjects : Must delete ordered work"></span></a>
                    <?php } ?>
                    </td>
                  </tr>
                  <?php
        ...
        ?>
        <div class="col-md-6">
          <h1 class="text-blue bigger-130 text-center">Edit subjects</h1>
          <div class="mt-3 pmd-card">
            <form class="form-horizontal" action="" method="post">
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="" class="control-label text-info bigger-110">Subjects ID</label>
              ...
              <div class="form-group">
                <label for="" class="control-label text-info bigger-110">Subjects name</label>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="" class="control-label text-info bigger-110">Class</label>
                  ...
                  <div class="col-sm-6">
                    <label for="" class="control-label text-info bigger-110">Colors</label>
              ...
              <div class="form-group text-right">
                ...
                <button type="submit" class="btn pmd-ripple-effect btn-default-fill">Save</button>
              </div>
            </form>
          </div>
        </div>
