    ...
    <div class="row">
      <div class="col-xs-12">
        <h1 class="section-title">
          ...
          <span class="media-middle">Score</span>
        </h1>
      </div>
    </div>
    <div class="row">
                ...
                <div class="progress-table">
                  <div class="static-progress">
                    <div class="header clearfix">
                      <p class="pull-left">Sent work within time</p>
                  ...
                  <div class="static-progress">
                    <div class="header clearfix">
                      <p class="pull-left">Not sent work within time</p>
                  ...
                  <div class="static-progress">
                    <div class="header clearfix">
                      <p class="pull-left">Attend class</p>
                  ...
                  <div class="homework clearfix mt-2">
                    ...
                    <?php
                      ...
                      <div class="col-xs-12">
                        ...
                        ?>
                        <li data-toggle="tooltip" title="<?php echo $homework_list[$j]->name; ?>">Work at <?php echo $homework_list[$j]->shortname; ?></li>
                        <?php
