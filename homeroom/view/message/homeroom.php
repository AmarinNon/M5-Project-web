    ...
    <div class="row">
      ...
      if(count($message)) {
        for($i = 0; $i < count($message); $i++){
          ...
          if($sent_user->role == 'Teacher'){ 
            ...
            $sent_form = 'From '.$sent_role.' / subjects '.$sent_subject->name.' Class '.$subject_homeroom->name;
          }
            ...
            $sent_form = 'From '.$sent_role.' / Number '.$student->group.' Sir. '.$sent_user->name.' '.$sent_user->surname;
          }
        ?>
      ...
      <?php }
        ...
        <div class="pmd-card pmd-z-depth fill-gray">
          <div class="pmd-card-title">
            <div class="media-body media-middle">
              <h2 class="pmd-card-title-text">To Parent / Student</h2>
            </div>
          </div>
          <div class="pmd-card-body">
            <form id="message_student_parent_form" action="" method="POST">
              ...
              <div class="form-group">
                <button name="submit_message_student_parent" class="btn btn-default-fill">Send message</button>
              </div>
            </form>
          </div>
        </div>
