...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '../../conf/tinymce'; // Relative to domain name
	$config['upload_path'] = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))).'/conf/tinymce'; // Physical path. [Usually works fine like this]
